				...
				<div className="collapse navbar-collapse" id="navbarSupportedContent">
					<ul className="navbar-nav ms-auto mb-2 mb-lg-0">
						<li className="nav-item" >
                            <button className="btn btn-link nav-link" onClick={goToHome}>
                                Home
                            </button>
						</li>
						{token ? (
                            ...
                            <li className="nav-item">
                                <button className="btn btn-link nav-link" onClick={goToLogin}>
                                    Login
                                </button>
