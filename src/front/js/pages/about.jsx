    ...
    return (
        <>
            ...
            <section className="about container text-center mt-5 mb-5" id='WhyChoose'>
                <div className="about__header mb-5">
                    <h2 className="about__title">About <strong>Us</strong>!</h2>
                ...
                <div className="about__benefits">
                    <div className="about__member about__member--one row ">
                        ...
                        <div className="about__content--member col-sm-12 col-md-6 col-lg-6 ">
                            <h3 className="about__subtitle">From Illustrator to <br /><strong>Full Stack Developer:</strong> Merging Creativity
                                and Technology</h3>
                    ...
                    <div className="about__member about__member--two row">
                        <div className="about__content--member col-sm-12 col-md-6 col-lg-6 ">
                            <h3 className="about__subtitle">Building Solutions <br /><strong>from the Ground Up</strong></h3>
                        ...
                        <div className="about__image col-sm-12 col-md-6 col-lg-6 ">
                            <img src="https://res.cloudinary.com/dfhhq651o/image/upload/v1738076855/about-jose-llorens_p6ddir.png" alt="Planificación de comidas" />
                        </div>
                    </div>
                </div>
            </section>
